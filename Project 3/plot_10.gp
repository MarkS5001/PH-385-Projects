...
set output 'solar_system_3D_10.gif'
...
stats 'resultsP3_10.txt' nooutput
...
do for [i=0:num_frames-1:50] {
    ...
    splot 'resultsP3_10.txt' every ::start_tail::i using 1:2:3 with linespoints pt 7 ps 0.5 lc rgb "green", \
